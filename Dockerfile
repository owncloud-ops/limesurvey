FROM docker.io/owncloudops/nginx:latest@sha256:63b2d21612f0e0549e1f83df5851abe1f2eb7c3cab6c7062b61d3a2bcec27c1b
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.3.6+231120}"
