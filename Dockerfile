FROM quay.io/owncloudops/nginx:latest@sha256:b93bb64f17873727a9fcacf3c011b1b049202ec7fe2cdf3d30f69a653d5a5fe2
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.0.1+230411}"
