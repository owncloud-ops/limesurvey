FROM docker.io/owncloudops/nginx:latest@sha256:812ce125516b94e0a93c23720040d8de7245a14e7d6b329ffe16f096d617d192
...
ENV SURVEY_VERSION="${BUILD_VERSION:-5.6.10+230313}"
