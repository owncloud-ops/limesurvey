FROM quay.io/owncloudops/nginx:latest@sha256:1721fe6fb6f0cc415c3dabc762d5b27c50eaadc11aa57ab93033e620febe65b0
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.2.5+230828}"
