FROM quay.io/owncloudops/nginx:latest@sha256:1dabcc3ef63697612edb77690b772e19a780a77b84c6bd5d562cd4e879ed2dc3
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.2.11+231007}"
