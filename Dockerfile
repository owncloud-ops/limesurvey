FROM docker.io/owncloudops/nginx:latest@sha256:c171a90437fb85d76ae4e2bec6e8e356aab603a30402bec575120df10794eed9
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.3.7+231127}"
