FROM quay.io/owncloudops/nginx:latest@sha256:c45adabbef377d249dd13cdb5e46eefa2fbf0cbb88049b6559d615ca96744429
...
ENV SURVEY_VERSION="${BUILD_VERSION:-5.6.13+230327}"
