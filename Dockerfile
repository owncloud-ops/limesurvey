FROM docker.io/owncloudops/nginx:latest@sha256:072aa1a4b576a5d927034bff221cc2d97d0d2a65ce611ddaa10771ac633f5d0a
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.4.4+240130}"
