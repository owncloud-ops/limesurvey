FROM quay.io/owncloudops/nginx:latest@sha256:8d2b22045e95527aabfd56ecbf9782ce55c39e52496c9c5a79f45650f65c4894
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.1.8+230717}"
