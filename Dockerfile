FROM quay.io/owncloudops/nginx:latest@sha256:034ce584ed463360b94d2583d19135498f36c4174e93f1d22599e7835837dc35
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.0.7+230515}"
