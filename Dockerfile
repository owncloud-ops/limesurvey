FROM docker.io/owncloudops/nginx:latest@sha256:a1b936634d98362fd950d865cb0a30c369a4969e85d0815dcbeb3081b93ca999
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.5.3+240415}"
