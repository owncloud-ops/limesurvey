FROM docker.io/owncloudops/nginx:latest@sha256:a7faa5ca72f84ac804c295ab9a0ed4053bb9a152b320b9ce8b78c1c24b9909ab
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.4.1+240108}"
