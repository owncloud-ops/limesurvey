FROM docker.io/owncloudops/nginx:latest@sha256:ac74f505b67bea20b2624e64b0b8d43ad9e512a947967314d04dc31de228f0c2
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.4.2+240115}"
