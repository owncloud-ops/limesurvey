FROM docker.io/owncloudops/nginx:latest@sha256:357e3045aa2a63e07a23ae2086b859544b6c8181b750808646d02508b4824a41
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.5.14+240624}"
