FROM docker.io/owncloudops/nginx:latest@sha256:f910d1e0b775cd6cc3ca7cc04139fae2a0f2ca3be62b2f36bc25fb586b370a83
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.3.9+231211}"
