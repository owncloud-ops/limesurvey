FROM quay.io/owncloudops/nginx:latest@sha256:ae2b52a6f2daaf4d26b0cc723bdd7a10fd0cb726d198c3eeeeb51ec8b7cf23c1
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.1.6+230703}"
