FROM quay.io/owncloudops/nginx:latest@sha256:f4696e09348176cfe9bf8663adee96229428b7e0ccb4637d13e2efd254015565
...
ENV SURVEY_VERSION="${BUILD_VERSION:-6.0.3+230424}"
